...
run("wget https://chromedriver.storage.googleapis.com/2.10/chromedriver_linux64.zip");
run("unzip chromedriver_linux64.zip");
if(!file_exists('artifacts')) mkdir('artifacts');
run('java -jar selenium-server-standalone-2.41.0.jar -Dwebdriver.chrome.driver="chromedriver" > artifacts/selenium.log 2>&1 &');
sleep(5);
